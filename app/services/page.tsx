      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="max-w-3xl mb-20">
          ...
          <h1 className="text-4xl md:text-6xl font-serif text-ivory tracking-tight leading-tight mb-6">
            Masajes Profesionales <span className="block mt-2 italic font-normal text-gold/90 font-serif">En Tu Ubicación</span>
          </h1>
        ...
        <div className="mt-24 p-8 rounded-3xl bg-charcoal-light border border-white/[0.03] max-w-4xl mx-auto flex flex-col sm:flex-row items-start gap-6">
          <div className="w-12 h-12 rounded-2xl flex items-center justify-center bg-gold/5 text-gold border border-gold/15 shrink-0">
