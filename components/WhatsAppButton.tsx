...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-40 flex items-center justify-center w-14 h-14 rounded-full bg-charcoal border border-gold/30 text-gold shadow-glass-md hover:border-gold hover:text-ivory transition-all duration-300 group"
      aria-label="Contactar por WhatsApp"
    >
      <div className="absolute inset-0 w-full h-full rounded-full bg-gold/5 animate-pulse" />
